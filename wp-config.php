<?php
$dbname = "mCMiaZybhmnkeuAMtBSq";
$table_prefix  = 'wp_sigh1988_test_0220_';
$bcs_bukect = 'wordpress';
?>
...
/** WordPress 数据库的名称 */
//define('DB_NAME', 'jiangtest2');
define('DB_NAME', $dbname);

/** MySQL 数据库用户名 */
//define('DB_USER', 'jiangtest2');
define('DB_USER', $user);

/** MySQL 数据库密码 */
//define('DB_PASSWORD', 'EuyN2U8tgIKBcV3SeXNf7n2h');
define('DB_PASSWORD', $pass);

/** MySQL 主机 */
//define('DB_HOST', '10.23.247.91::3306');
define('DB_HOST', $host);
